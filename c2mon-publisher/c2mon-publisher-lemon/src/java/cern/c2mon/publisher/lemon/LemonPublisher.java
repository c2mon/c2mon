...
/**
 * This class publishes updates of DIAMON CLIC metrics to LEMON For each computer we are collecting the individual
 * metric updates by scheduling a packet sender. The current version implements only the non-authenticated LEMON
 * protocol
 * 
 * @author Peter Jurcso
 */
...
public class LemonPublisher implements Publisher {
    ...
    /*
     * Loads Lemon template from local file or from web server with the following format:
     * 
    ...
    /*
     * Loads Lemon Static data from local file or from web server with the following format:
     * 
