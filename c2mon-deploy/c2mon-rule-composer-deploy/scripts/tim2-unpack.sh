...
# folder where tim2-rule-composer should be unpacked
DEST_FOLDER=~/dist/public/test/html/javaws/tim2-rule-composer
PREV_FOLDER=${DEST_FOLDER}-prev

#expected location of tar.gz file
TAR_FILE=/tmp/c2mon-rule-composer-tim2-tim2.tar.gz
