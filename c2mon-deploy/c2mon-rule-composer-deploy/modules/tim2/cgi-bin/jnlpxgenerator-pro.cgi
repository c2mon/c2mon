...
print "<?xml version = '1.0' encoding = 'utf-8'?>
  ...
  <information>
    <title>TIM Rule Composer ($viewerVersion)</title>
    <vendor>Technical Infrastructure Monitoring (TIM) Team</vendor>
    <homepage href=\"http://timweb.cern.ch\"/>
    <description>This application allows creating server rules for the TIM2 system.</description>
...
if ($viewerVersion =~ /-SNAPSHOT/) {
  print "    <property name=\"app.name\" value=\"tim-rule-composer-test\"/>\n";
} else {
  print "    <property name=\"app.name\" value=\"tim-rule-composer-pro\"/>\n";
}
...
print "  </resources>
  <resources os=\"Windows\" >
    <property name=\"tim.log.file\" value=\"c:\\temp\\tim-rule-composer.log\"/>
  </resources>
  <application-desc main-class=\"ch.cern.tim.rule.composer.RuleComposer\"/>
</jnlp>" , "\n";
