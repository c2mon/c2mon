...
my $c2monClientPropertiesURL  = "http://timweb/test/conf/psaccess-client.properties";
...
print "<?xml version = '1.0' encoding = 'utf-8'?>
  ...
  <information>
    <title>TIM PS Access Control TEST ($viewerVersion)</title>
...
print "    <property name=\"app.name\" value=\"tim-psaccess-control-dev\"/>\n";
