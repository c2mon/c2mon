...
USER=alaser
DEST_FOLDER=/tmp
TAR_FILE=./modules/dmn2/build/c2mon-dashboard-editor-dmn2-dmn2.tar.gz

UNPACK_SCRIPT=./scripts/dmn2-unpack.sh
...
ssh ${USER}@${HOST} "/tmp/dmn2-unpack.sh;rm -rf /tmp/dmn2-unpack.sh"