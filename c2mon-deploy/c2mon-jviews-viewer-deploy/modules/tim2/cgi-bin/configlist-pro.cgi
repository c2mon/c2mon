...
my $title = "TIM Viewer (" . $viewerVersion . ") Configurations";
...
foreach (@files) {
  ...
  print "<li>Use ";
  print a({-href=>"../bin/tim-viewer-$fn.jnlpx"}, "CERN JWS (recommended)");
  print " or ";
  print a({-href=>"../bin/tim-viewer-$fn.jnlp"}, "Java Web Start");
