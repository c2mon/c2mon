...
my $title = "TIM Viewer Test (" . $viewerVersion . "): Connecting to the TIM test server";
...
foreach (@files) {
  ...
  print "<li>Use ";
  print a({-href=>"../bin/tim-viewer-dev-$fn.jnlpx"}, "CERN JWS (recommended)");
  print " or ";
  print a({-href=>"../bin/tim-viewer-dev-$fn.jnlp"}, "Java Web Start");
