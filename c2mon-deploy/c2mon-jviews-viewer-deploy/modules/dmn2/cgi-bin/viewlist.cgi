...
my $basedir = "/user/alaser/public_html/dmn2-views";
my $baseurl = "http://cs-ccr-www1.cern.ch/~alaser/dmn2-views";

# Reading property file ~/rep/c2mon/.c2mon.properties #
open PROPS, "< /user/diamonop/c2mon/test/conf/.c2mon.properties"
  or die
"Unable to open configuration file ~diamonop/c2mon/test/conf/.c2mon.properties";
...
my $dbiUrl = $c2monProperties->getProperty("dbi.config.url");
