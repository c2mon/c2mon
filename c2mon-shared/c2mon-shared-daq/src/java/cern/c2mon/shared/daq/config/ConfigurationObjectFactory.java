 ...
 * extend/change this class and still want to use the generic way to create the
 * change objects. Be sure to match with your creation methods the name
...
public class ConfigurationObjectFactory extends ObjectFactory implements ConfigurationXMLConstants {
  ...
  /**
   * Generates a list of changes for the elements in this configuration change
   * event.
   *
   * @param configurationChangeEventElement The configuration change event
   *          element.
   ...
   */
  public List<Change> generateChanges(final Element configurationChangeEventElement) throws NoSuchFieldException, IllegalAccessException,
  ...
  /**
   * Creates a new configuration change event report and fills it with the
   * values in the provided DOM element.
   *
   * @param configurationChangeEventReportElement The element with the values to
   *          fill in.
   * @return The new and filled ConfigurationChangeEventReport object.
   * @throws NoSuchFieldException May throw a NoSuchFieldException.
   * @throws IllegalAccessException May throw a IllegalAccessException.
   * @throws NoSimpleValueParseException This exception is thrown if the
   *           converted xml name matches a complex java field which cannot be
   *           converted.
   */
  public ConfigurationChangeEventReport createConfigurationChangeEventReport(final Element configurationChangeEventReportElement) throws NoSuchFieldException,
    ...
    List<Element> complexElements = fillConfigurationChangeEventReport(configurationChangeEventReportElement, configurationChangeEventReport);
  ...
  /**
   * Fills a configuration change event report with the values in the provided
   * DOM element.
   *
   ...
   * @return Returns a list of elements which could not be processed
   *         automatically.
   * @throws NoSuchFieldException May throw a NoSuchFieldException.
   * @throws IllegalAccessException May throw a IllegalAccessException.
   * @throws NoSimpleValueParseException This exception is thrown if the
  ...
  public List<Element> fillConfigurationChangeEventReport(final Element configurationChangeEventReportElement,
      final ConfigurationChangeEventReport configurationChangeEventReport) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  private ChangeReport createChangeReport(final Element changeReportElement) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillChangeReport(final Element changeReportElement, final ChangeReport changeReport) throws NoSuchFieldException,
      IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public DataTagUpdate createDataTagUpdate(final Element element) throws NoSuchFieldException, IllegalAccessException, InstantiationException,
      ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillDataTagUpdate(final Element element, final DataTagUpdate dataTagUpdate) throws NoSuchFieldException, IllegalAccessException,
      InstantiationException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException {
    ...
    for (Element child : complexChildElements) {
      if (child.getTagName().equals(MIN_VALUE_ELEMENT) || child.getTagName().equals((MAX_VALUE_ELEMENT))) {
        evaluateBoundaryValue(dataTagUpdate, child.getAttribute(DATA_TYPE_ATTRIBUTE), child.getTextContent(), child);
   ...
   *           converted.
   */
  public CommandTagUpdate createCommandTagUpdate(final Element element) throws NoSuchFieldException, IllegalAccessException, InstantiationException,
      ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillCommandTagUpdate(final Element element, final CommandTagUpdate commandTagUpdate) throws NoSuchFieldException,
      IllegalAccessException, InstantiationException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public EquipmentConfigurationUpdate createEquipmentConfigurationUpdate(final Element element) throws NoSuchFieldException, IllegalAccessException,
   ...
   *
   * @param element The element to use to create the update.
   * @param equipmentConfigurationUpdate The EquipmentConfigurationUpdate to
   *          fill.
   ...
   *           converted.
   */
  public List<Element> fillEquipmentConfigurationUpdate(final Element element, final EquipmentConfigurationUpdate equipmentConfigurationUpdate)
   ...
   *           converted.
   */
  public ProcessConfigurationUpdate createProcessConfigurationUpdate(final Element element) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillProcessConfigurationUpdate(final Element element, final ProcessConfigurationUpdate processConfigurationUpdate)
      throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public DataTagAdd createDataTagAdd(final Element element) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillDataTagAdd(final Element element, final DataTagAdd dataTagAdd) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillEquipmentUnitAdd(final Element element, final EquipmentUnitAdd eqUnitAdd) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillEquipmentUnitRemove(final Element element, final EquipmentUnitRemove eqUnitRem) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
   ...
   *           converted.
   */
  public CommandTagAdd createCommandTagAdd(final Element element) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillCommandTagAdd(final Element element, final CommandTagAdd commandTagAdd) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
   ...
   *           converted.
   */
  public DataTagRemove createDataTagRemove(final Element element) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillDataTagRemove(final Element element, final DataTagRemove dataTagRemove) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
   ...
   *           converted.
   */
  public CommandTagRemove createCommandTagRemove(final Element element) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillCommandTagRemove(final Element element, final CommandTagRemove commandTagRemove) throws NoSuchFieldException,
      IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public DataTagAddressUpdate createDataTagAddressUpdate(final Element element) throws NoSuchFieldException, IllegalAccessException, InstantiationException,
      ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public List<Element> fillDataTagAddressUpdate(final Element element, final DataTagAddressUpdate dataTagAddressUpdate) throws NoSuchFieldException,
      IllegalAccessException, InstantiationException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException {
   ...
   *           converted xml name matches a complex java field which cannot be
   *           converted.
   * @throws NoSuchFieldException Throws a no such field exception if a tag name
   *           in the DOM element cannot be found in the hardware address
   *           object. (After the name of the tag was converted by name
   *           conventions).
   */
  public HardwareAddressUpdate createHardwareAddressUpdate(final Element element) throws InstantiationException, IllegalAccessException,
      ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException, NoSuchFieldException {
   ...
   *           conventions).
   */
  public void fillHardwareAddressUpdate(final Element element, final HardwareAddressUpdate hardwareAddressUpdate) throws InstantiationException,
      IllegalAccessException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, NoSimpleValueParseException, NoSuchFieldException {
    ...
    for (int i = 0; i < attributes.getLength(); i++) {
      ...
      if (!attributeName.equals(HW_CLASS_ATTRIBUTE)) {
        ...
        hardwareAddressUpdate.getChangedValues().put(javaFieldName, parse(attribute.getTextContent(), javaFieldName, hardwareAddress.getClass()));
      } else {
    ...
    for (int i = 0; i < nodes.getLength(); i++) {
      ...
      if (node.getNodeType() == Node.ELEMENT_NODE) {
        ...
        if (childElement.hasAttribute(UPDATE_ATTRIBUTE) && childElement.getAttribute(UPDATE_ATTRIBUTE).equals(REMOVE_VALUE)) {
          hardwareAddressUpdate.addFieldToRemove(xmlNameToJavaName(elementName));
        } else {
          String javaFieldName = xmlNameToJavaName(elementName);
          hardwareAddressUpdate.getChangedValues().put(javaFieldName, parse(childElement.getTextContent(), javaFieldName, hardwareAddress.getClass()));
        }
      }
    }
  }
  ...
  /**
   * Evaluates boundary values (min-value and max-value) and adds them to the
   * update object.
   *
   ...
   */
  private void evaluateBoundaryValue(final DataTagUpdate dataTagUpdate, final String dataType, final String value, final Element tag) {
  ...
  /**
   * Evaluates all elements in the provided list concerning their update
   * attribute.
   *
   ...
   *           converted.
   */
  private List<Element> evaluateUpdateAttributes(final List<Element> complexChildElements, final ChangePart changePart) throws NoSuchFieldException,
      IllegalAccessException, NoSimpleValueParseException {
    List<Element> notProcessedElements = new ArrayList<Element>();
  ...
  /**
   * Evaluates the elements update attribute and updates the change part. Only
   * use this with elements which actually have an update attribute.
   *
   ...
   *           converted.
   */
  private void evaluateUpdateAttribute(final ChangePart changePart, final Element child) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
   ...
   *           converted.
   */
  public EquipmentUnitAdd createEquipmentUnitAdd(final Element element) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
   ...
   *           converted.
   */
  public EquipmentUnitRemove createEquipmentUnitRemove(final Element element) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
  ...
  /**
   * Creates a subequipment unit remove event.
   *
   * @param element The DOM element to use.
   * @return The new equipment remove event
   * @throws NoSuchFieldException May throw a NoSuchFieldException.
   ...
   *           converted.
   */
  public SubEquipmentUnitAdd createSubEquipmentUnitAdd(final Element element) throws NoSuchFieldException, IllegalAccessException, NoSimpleValueParseException {
    SubEquipmentUnitAdd subEqUnitAdd = new SubEquipmentUnitAdd();

    List<Element> complexChildElements = fillSubEquipmentUnitAdd(element, subEqUnitAdd);

    for (Element child : complexChildElements) {
      if (child.getTagName().equals(SUB_EQUIPMENT_UNIT_XML)) {
        subEqUnitAdd.setSubEquipmentUnitXml(child.getFirstChild().getTextContent());
      }
    }
    return subEqUnitAdd;
  }
   ...
   *           converted.
   */
  private List<Element> fillSubEquipmentUnitAdd(Element element, SubEquipmentUnitAdd subEqUnitAdd) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
    return initSimpleFields(subEqUnitAdd, element);
  }
   ...
   *           converted.
   */
  public SubEquipmentUnitRemove createSubEquipmentUnitRemove(final Element element) throws NoSuchFieldException, IllegalAccessException,
      NoSimpleValueParseException {
    SubEquipmentUnitRemove subEqUnitRemove = new SubEquipmentUnitRemove();
    fillSubEquipmentUnitRemove(element, subEqUnitRemove);
    return subEqUnitRemove;
  }
   ...
   *
   * @param element The DOM element to use.
   * @param eqUnitAdd The equipment unit remove event to fill.
   * @return Returns all elements which could not be processed automatically.
   * @throws NoSuchFieldException May throw a NoSuchFieldException.
   * @throws IllegalAccessException May throw a IllegalAccessException.
   * @throws NoSimpleValueParseException This exception is thrown if the
   ...
   *           converted.
   */
  private List<Element> fillSubEquipmentUnitRemove(Element element, SubEquipmentUnitRemove subEqUnitRemove) throws NoSuchFieldException,
      IllegalAccessException, NoSimpleValueParseException {
    return initSimpleFields(subEqUnitRemove, element);
  }
}
