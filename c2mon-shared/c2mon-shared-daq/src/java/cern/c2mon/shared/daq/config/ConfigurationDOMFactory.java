...
public class ConfigurationDOMFactory extends DOMFactory implements ConfigurationXMLConstants, ConfigurationJavaConstants {
   ...
   * @throws ParserConfigurationException May throw a
   ...
   */
  public String createConfigurationXMLString(final List<Change> changes) throws ParserConfigurationException, IllegalAccessException, InstantiationException,
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public String createConfigurationChangeEventReportXMLString(final ConfigurationChangeEventReport configurationChangeEventReport) throws TransformerException,
   ...
   *
   * @param configurationChangeEventReport The configuration change event report
   *          to use.
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Document createConfigurationChangeEventReportDocument(final ConfigurationChangeEventReport configurationChangeEventReport)
  ...
  /**
   * Creates a configuration change event report element as part of the provided
   * document. But does not add it to the tree.
   *
   * @param document The document to create the element.
   * @param configurationChangeEventReport The report class to use the values
   *          from.
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createConfigurationChangeReportElement(final Document document, final ConfigurationChangeEventReport configurationChangeEventReport)
      throws ParserConfigurationException, IllegalAccessException, InstantiationException {
    Element configurationChangeReportElement = generateSimpleElement(document, configurationChangeEventReport);
    // Error field should only be set if all reports failed => only use the list
    // if nothing present
  ...
  /**
   * Creates a report element for a single change. But doesn't add it to the
   * document.
   *
   * @param document The document to create the element.
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  private Element createChangeReportElement(final Document document, final ChangeReport report) throws ParserConfigurationException, IllegalAccessException,
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Document createConfigurationDocument(final List<Change> changes) throws ParserConfigurationException, IllegalAccessException, InstantiationException {
    ...
    for (Change change : changes) {
      ...
      if (change instanceof DataTagAdd) {
        ...
        element = createSubEquipmentUnitAddElement(newDocument, (SubEquipmentUnitAdd) change);
      } else if (change instanceof SubEquipmentUnitRemove) {
        element = createSubEquipmentUnitRemoveElement(newDocument, (SubEquipmentUnitRemove) change);
      }
  ...
  public Element createEquipmentUnitAddElement(final Document document, final EquipmentUnitAdd eqUnitAdd) throws ParserConfigurationException,
  ...
  public Element createEquipmentUnitRemoveElement(final Document document, final EquipmentUnitRemove eqUnitRemove) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
  ...
  public Element createSubEquipmentUnitAddElement(final Document document, final SubEquipmentUnitAdd subEqUnitAdd) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element subEqAddElement = generateSimpleElement(document, subEqUnitAdd, CHANGE_ID_FIELD, EQUIPMENT_ID_FIELD, SUB_EQUIPMENT_ID_FIELD);
    return subEqAddElement;
  }

  public Element createSubEquipmentUnitRemoveElement(final Document document, final SubEquipmentUnitRemove subEqUnitRemove)
      throws ParserConfigurationException, IllegalAccessException, InstantiationException {
    Element subEqUnitRemoveElement = generateSimpleElement(document, subEqUnitRemove, CHANGE_ID_FIELD, EQUIPMENT_ID_FIELD, SUB_EQUIPMENT_ID_FIELD);
    return subEqUnitRemoveElement;
  }

  /**
   * Creates a configuration change event element. This is the root element for
  ...
  public Element createConfigurationChangeEventElement(final Document document) {
    Element configurationChangeEventElement = document.createElementNS(getDefaultNamespace(), CONFIGURATION_CHANGE_EVENT_ELEMENT);
    ...
    configurationChangeEventElement.setAttribute("xsi:schemaLocation",
   ...
   *
   * @param document The document in which context the element should be
   *          created.
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createDataTagUpdateElement(final Document document, final DataTagUpdate dataTagUpdate) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element dataTagUpdateElement = generateSimpleElement(document, dataTagUpdate, CHANGE_ID_FIELD, DATA_TAG_ID_FIELD, EQUIPMENT_ID_FIELD);
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createCommandTagUpdateElement(final Document document, final CommandTagUpdate commandTagUpdate) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element commandTagUpdateElement = generateSimpleElement(document, commandTagUpdate, CHANGE_ID_FIELD, COMMAND_TAG_ID_FIELD, EQUIPMENT_ID_FIELD);
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createEquipmentUnitUpdateElement(final Document document, final EquipmentConfigurationUpdate equipmentConfigurationUpdate)
      throws ParserConfigurationException, IllegalAccessException, InstantiationException {
    Element equipmentUnitUpdateElement = generateSimpleElement(document, equipmentConfigurationUpdate, CHANGE_ID_FIELD, EQUIPMENT_ID_FIELD);
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createProcessUpdateElement(final Document document, final ProcessConfigurationUpdate processConfigurationUpdate)
      throws ParserConfigurationException, IllegalAccessException, InstantiationException {
    Element processUpdateElement = generateSimpleElement(document, processConfigurationUpdate, CHANGE_ID_FIELD, PROCESS_ID_FIELD);
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createDataTagAddElement(final Document document, final DataTagAdd dataTagAdd) throws ParserConfigurationException, IllegalAccessException,
      InstantiationException {
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createSourceDataTagElement(final Document document, final SourceDataTag sourceDataTag) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element sourceDataTagElement = generateSimpleElement(document, DATA_TAG_ELEMENT, sourceDataTag, ID_FIELD, NAME_FIELD, CONTROL_FIELD);
  ...
  /**
   * Sets the boundary data type of a min- or max-value element in the provided
   * element.
   *
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createDataTagAddressElement(final Document document, final DataTagAddress address) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createHardwareAddressElement(final Document document, final HardwareAddress hardwareAddress) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createCommandTagAddElement(final Document document, final CommandTagAdd commandTagAdd) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element commandTagAddElement = generateSimpleElement(document, commandTagAdd, CHANGE_ID_FIELD, EQUIPMENT_ID_FIELD);
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createCommandTagElement(final Document document, final SourceCommandTag sourceCommandTag) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element commandTagElement = generateSimpleElement(document, COMMAND_TAG_ELEMENT, sourceCommandTag, ID_FIELD, NAME_FIELD, MODE_FIELD);
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createDataTagAddressUpdateElement(final Document document, final DataTagAddressUpdate dataTagAddressUpdate)
      throws ParserConfigurationException, IllegalAccessException, InstantiationException {
    Element dataTagAddressUpdateElement = generateSimpleElement(document, DATA_TAG_ADDRESS_ELEMENT, dataTagAddressUpdate);
    ...
    if (hardwareAddressUpdate != null) {
      dataTagAddressUpdateElement.appendChild(createHardwareAddressUpdateElement(document, hardwareAddressUpdate));
    }
   ...
   */
  public Element createHardwareAddressUpdateElement(final Document document, final HardwareAddressUpdate hardwareAddressUpdate) {
    Element hardwareAddressUpdateElement = document.createElementNS(getDefaultNamespace(), HARDWARE_ADDRESS_ELEMENT);
    ...
    for (Entry<String, Object> entry : hardwareAddressUpdate.getChangedValues().entrySet()) {
      // if there's no value for that entry (entry is null) - don't append empty
      // child tag
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createDataTagRemoveElement(final Document document, final DataTagRemove dataTagRemove) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element dataTagRemoveElement = generateSimpleElement(document, dataTagRemove, CHANGE_ID_FIELD, DATA_TAG_ID_FIELD, EQUIPMENT_ID_FIELD);
   ...
   * @throws InstantiationException May throw a InstantiationException.
   */
  public Element createCommandTagRemoveElement(final Document document, final CommandTagRemove commandTagRemove) throws ParserConfigurationException,
      IllegalAccessException, InstantiationException {
    Element commandTagRemoveElement = generateSimpleElement(document, commandTagRemove, CHANGE_ID_FIELD, COMMAND_TAG_ID_FIELD, EQUIPMENT_ID_FIELD);
   ...
   * @param document The document in which context the element should be
   *          created.
   * @param elementToAppend The element where the remove elements should be
   *          appended.
   * @param fieldsToRemove The list of fields to remove.
   */
  private void appendRemoveAttributes(final Document document, final Element elementToAppend, final List<String> fieldsToRemove) {
  ...
  /**
   * Creates a new element with the provided name (will be converted with
   * javaNametoXMLName()) and value.
   *
   * @param document The document in which context the element should be
   *          created.
