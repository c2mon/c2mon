...
public class VideoConnectionProperties {
   ...
   */
  public final void setKeysTaken(final int keysTaken) {
  ...
  */
   ...
   */
  public final void setQueueingTagId(final long queueingTagId) {
    this.queueingTagId = queueingTagId;
  }
   ...
   */
  public final void setActivationTagId(final long activationTagId) {
    this.activationTagId = activationTagId;
  }
   ...
   */
  public final void setKeysTakenTagId(final long keysTakenTagId) {
    this.keysTakenTagId = keysTakenTagId;
  }
   ...
   */
  public final void setCamera(final int camera) {
    this.camera = camera;
  }
}
