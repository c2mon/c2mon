...
![process-equipment]({{ site.baseurl }}{% link assets/img/overview/process-equipment.png %})
...
![process-data-relation]({{ site.baseurl }}{% link assets/img/overview/process-data-relation.png %})
