...
This guide assumes that you are familiar with the [core concepts](c2mon/docs/overview/) of C2MON. At the end of this guide you should be able to write your
