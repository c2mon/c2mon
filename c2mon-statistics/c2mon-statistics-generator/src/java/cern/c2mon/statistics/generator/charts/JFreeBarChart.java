...
public class JFreeBarChart extends JFreeWebChart {
   ...
   */
  @Override
  public void configure(Element chartElement, TimChartStyles timChartStyles) throws GraphConfigException, SQLException, InvalidTableNameException {
