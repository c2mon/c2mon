...
//    convertToTagES(Boolean.FALSE, TagDocument.TYPE_BOOLEAN);
//
//    convertToTagES(Integer.MAX_VALUE, TagDocument.TYPE_NUMBER);
//    convertToTagES(0, TagDocument.TYPE_NUMBER);
//    convertToTagES(null, "Integer", TagDocument.TYPE_NUMBER);
//
//    convertToTagES(Long.MIN_VALUE, TagDocument.TYPE_NUMBER);
//    convertToTagES(Double.MIN_VALUE, TagDocument.TYPE_NUMBER);
//    convertToTagES(Float.MIN_VALUE, TagDocument.TYPE_NUMBER);
//    convertToTagES(Short.MAX_VALUE, TagDocument.TYPE_NUMBER);
//
//    convertToTagES("John Lennon", TagDocument.TYPE_STRING);
//
//    ComplexType test = new ComplexType();
//    test.setBool(true);
//    test.setInteger(5);
//    test.setString("Paul McCartney");
//    convertToTagES(new GsonBuilder().create().toJson(test), test.getClass().getName(), TagDocument.TYPE_OBJECT);
//
//  }
//
...
//
//    TagDocument esTag = tagConverter.convert(tagC2MON);
...
//
//    TagDocument esTag = tagConverter.convert(tag);
//    assertEquals(esTag.getType(), TagDocument.TYPE_BOOLEAN);
...
//    TagDocument esTag = tagConverter.convert(tag);
//
//    assertEquals(TagDocument.TYPE_BOOLEAN, esTag.getType());
