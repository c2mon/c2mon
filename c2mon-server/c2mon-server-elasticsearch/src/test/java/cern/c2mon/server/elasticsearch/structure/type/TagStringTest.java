...
//    TagDocument tagString = new TagDocument(1L, String.class.getName());
...
//    TagDocument tag = new TagDocument(192506L, String.class.getName());
//
...
//    IFallback result = new TagDocument().getObject(expectedTagJson);
//    assertTrue(result instanceof TagDocument);
