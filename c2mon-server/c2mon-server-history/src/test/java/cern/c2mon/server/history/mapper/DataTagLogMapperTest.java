...
import cern.c2mon.server.history.structure.HistoricTag;
...
@ContextConfiguration({"classpath:config/server-history-mapper-test.xml"})
public class DataTagLogMapperTest {
  ...
  public void testInsertDataTagLog() {
    ...
    dataTagLogMapper.insertLog(tag);
  }
