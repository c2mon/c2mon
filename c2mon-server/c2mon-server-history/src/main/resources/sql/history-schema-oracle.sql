...
PRIMARY KEY (EXPR_TAGID, EXPR_NAME, EXPR_TIMESTAMP)

CREATE TABLE IF NOT EXISTS DSLEXPRESSION_LOG (
  EX_ID          INTEGER      NOT NULL,
  EX_DESCRIPTION VARCHAR(4000),
  EX_DATATYPE    VARCHAR(200) NOT NULL,
  EX_VALUE       VARCHAR(4000),
  EX_TIMESTAMP   DATE,
  PRIMARY KEY (EX_ID, EXPR_TIMESTAMP)
);
