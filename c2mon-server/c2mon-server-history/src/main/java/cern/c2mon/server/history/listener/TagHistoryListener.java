 ...
 */
@Service
public class TagHistoryListener implements C2monBufferedCacheListener<Tag>, SmartLifecycle {

  /**
   * Class logger.
   */
  private static final Logger LOGGER = LoggerFactory.getLogger(TagHistoryListener.class);
   ...
   */
  @Autowired
  public TagHistoryListener(final CacheRegistrationService cacheRegistrationService, @Qualifier("tagLogger") final BatchLogger<Tag> tagLogger) {
    super();
