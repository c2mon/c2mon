...
public class EquipmentConfigTest extends ConfigurationCacheLoaderTest<Equipment> {
  ...
  public void createFromDbCreatesControlTags() {
    ...
    assertEquals(expectedObject.getId(), commFaultTagCache.get(expectedObject.getCommFaultTagId()).getSupervisedId().longValue());
  }
...
//    assertNull(controlTagMapper.getItem(1224L));
  ...
  public void createEquipment() {
    ...
    expectedObject.setAliveTagId(300_002L);
    expectedObject.setCommFaultTagId(300_000L);
    expectedObject.setStateTagId(300_001L);
