...
//    Process.ProcessBuilder tempBuild = Process.builder().id(1L);
   ...
   */
  @SafeVarargs
  public static Configuration getConfBuilderDataTagE(DataTag... elements) {
    Equipment.EquipmentBuilder tempBuild = Equipment.builder().id(1L);
  ...
  @SafeVarargs
  public static Configuration getConfBuilderDataTagE(Long equipmentId, Long processId, DataTag... elements) {
    Equipment.EquipmentBuilder tempBuild = Equipment.builder().id(equipmentId);
    for (DataTag element : elements) {
      tempBuild.dataTag(element);
    }
