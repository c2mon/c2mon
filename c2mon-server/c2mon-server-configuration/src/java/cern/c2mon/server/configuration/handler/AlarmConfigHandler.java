...
/**
 * Manages the creation, update and removal of alarms during server runtime.
...
public class AlarmConfigHandler {
   ...
   * Class logger.
   */
  private static final Logger LOGGER = Logger.getLogger(AlarmConfigHandler.class);
   ...
   */
  @Autowired
  public AlarmConfigHandler(final AlarmFacade alarmFacade, final AlarmLoaderDAO alarmDAO, 
