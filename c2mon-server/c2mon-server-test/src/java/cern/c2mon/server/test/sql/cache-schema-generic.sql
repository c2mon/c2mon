...
ALTER TABLE PROPERTY ADD
  CONSTRAINT PK_PROP_DEVCLASSID_PROPNAME PRIMARY KEY (PROPDEVCLASSID, PROPNAME);
...
ALTER TABLE COMMAND ADD
  CONSTRAINT PK_CMD_CMDDEVCLASSID_CMDNAME PRIMARY KEY (CMDDEVCLASSID, CMDNAME);
...
CREATE TABLE DEVICEPROPERTY (
  ...
  DVPTAGID          INTEGER,
  DVPRULE           VARCHAR(4000),
  DVPCONST          VARCHAR(4000),
  DVPRESULTTYPE     VARCHAR(20)
  );

ALTER TABLE DEVICEPROPERTY ADD
  CONSTRAINT PK_DVP_DVPDEVID_DVPNAME PRIMARY KEY (DVPDEVID, DVPNAME);

ALTER TABLE DEVICEPROPERTY ADD
  CONSTRAINT FK_DVP_DEVID_DEVICE FOREIGN KEY (DVPDEVID) REFERENCES DEVICE (DEVID);

ALTER TABLE DEVICEPROPERTY ADD
  CONSTRAINT UQ_DVP_DVPTAGID UNIQUE (DVPTAGID);

-- ALTER TABLE DEVICEPROPERTY ADD
--   CONSTRAINT FK_DVP_PROPNAME_PROPERTY FOREIGN KEY (DVPNAME) REFERENCES PROPERTY (PROPNAME);
...
CREATE TABLE DEVICECOMMAND (
  ...
  DVCTAGID          INTEGER NOT NULL
  );

ALTER TABLE DEVICECOMMAND ADD
  CONSTRAINT PK_DVC_DVCDEVID_DVCNAME PRIMARY KEY (DVCDEVID, DVCNAME);

ALTER TABLE DEVICECOMMAND ADD
  CONSTRAINT FK_DVC_DEVID_DEVICE FOREIGN KEY (DVCDEVID) REFERENCES DEVICE (DEVID);

ALTER TABLE DEVICECOMMAND ADD
  CONSTRAINT UQ_DVC_DVCTAGID UNIQUE (DVCTAGID);

--  ALTER TABLE DEVICECOMMAND ADD
--    CONSTRAINT FK_DVC_CMDNAME_COMMAND FOREIGN KEY (DVCNAME) REFERENCES COMMAND (CMDNAME);