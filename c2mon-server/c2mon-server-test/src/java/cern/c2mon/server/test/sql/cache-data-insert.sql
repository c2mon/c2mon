...
-- properties
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (400, 'cpuLoadInPercent', 'The current CPU load in percent');
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (400, 'responsiblePerson', 'The person responsible for this device');
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (400, 'someCalculations', 'Some super awesome calculations');
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (400, 'numCores', 'The number of CPU cores on this device');
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (401, 'TEST_PROPERTY_1', 'Description of TEST_PROPERTY_1');
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (401, 'TEST_PROPERTY_2', 'Description of TEST_PROPERTY_2');
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (401, 'TEST_PROPERTY_3', 'Description of TEST_PROPERTY_3');
INSERT INTO PROPERTY (PROPDEVCLASSID, PROPNAME, PROPDESC)
VALUES (401, 'TEST_PROPERTY_4', 'Description of TEST_PROPERTY_4');
-- commands
INSERT INTO COMMAND (CMDDEVCLASSID, CMDNAME, CMDDESC)
VALUES (400, 'TEST_COMMAND_1', 'Description of TEST_COMMAND_1');
INSERT INTO COMMAND (CMDDEVCLASSID, CMDNAME, CMDDESC)
VALUES (400, 'TEST_COMMAND_2', 'Description of TEST_COMMAND_2');
INSERT INTO COMMAND (CMDDEVCLASSID, CMDNAME, CMDDESC)
VALUES (401, 'TEST_COMMAND_3', 'Description of TEST_COMMAND_3');
INSERT INTO COMMAND (CMDDEVCLASSID, CMDNAME, CMDDESC)
VALUES (401, 'TEST_COMMAND_4', 'Description of TEST_COMMAND_4');
-- devices
...
-- device properties
INSERT INTO DEVICEPROPERTY (DVPDEVID, DVPNAME, DVPTAGID, DVPRULE, DVPCONST, DVPRESULTTYPE)
VALUES (300, 'cpuLoadInPercent', 210000, NULL, NULL, NULL);
INSERT INTO DEVICEPROPERTY (DVPDEVID, DVPNAME, DVPTAGID, DVPRULE, DVPCONST, DVPRESULTTYPE)
VALUES (300, 'responsiblePerson', NULL, NULL, 'Mr. Administrator', NULL);
INSERT INTO DEVICEPROPERTY (DVPDEVID, DVPNAME, DVPTAGID, DVPRULE, DVPCONST, DVPRESULTTYPE)
VALUES (300, 'someCalculations', NULL, '(#123 + #234) / 2', NULL, 'Float');
INSERT INTO DEVICEPROPERTY (DVPDEVID, DVPNAME, DVPTAGID, DVPRULE, DVPCONST, DVPRESULTTYPE)
VALUES (300, 'numCores', NULL, NULL, '4', 'Integer');
INSERT INTO DEVICEPROPERTY (DVPDEVID, DVPNAME, DVPTAGID, DVPRULE, DVPCONST, DVPRESULTTYPE)
VALUES (301, 'TEST_PROPERTY_1', 210001, NULL, NULL, NULL);
INSERT INTO DEVICEPROPERTY (DVPDEVID, DVPNAME, DVPTAGID, DVPRULE, DVPCONST, DVPRESULTTYPE)
VALUES (302, 'TEST_PROPERTY_2', 210002, NULL, NULL, NULL);
INSERT INTO DEVICEPROPERTY (DVPDEVID, DVPNAME, DVPTAGID, DVPRULE, DVPCONST, DVPRESULTTYPE)
VALUES (303, 'TEST_PROPERTY_3', 210003, NULL, NULL, NULL);
-- device commands
INSERT INTO DEVICECOMMAND (DVCDEVID, DVCNAME, DVCTAGID)
VALUES (300, 'TEST_COMMAND_1', 210004);
INSERT INTO DEVICECOMMAND (DVCDEVID, DVCNAME, DVCTAGID)
VALUES (301, 'TEST_COMMAND_2', 210005);
INSERT INTO DEVICECOMMAND (DVCDEVID, DVCNAME, DVCTAGID)
VALUES (302, 'TEST_COMMAND_3', 210006);
INSERT INTO DEVICECOMMAND (DVCDEVID, DVCNAME, DVCTAGID)
VALUES (303, 'TEST_COMMAND_4', 210007);