...
VALUES (150, 'E_TESTHANDLER_TESTHANDLER03', 'TESTHANDLER03 EQUIPMENT', 'cern.c2mon.driver.testhandler.TestMessageHandler', 1222, 1224, 60000, 1223, 50, 'interval=1000;eventProb=0.02;inRangeProb=1;outDeadBandProb=1;switchProb=1;startIn=0.2;aliveInterval=30000');
