...
public class SequenceDAOImpl implements SequenceDAO {
  ...
  @Override
  public Long getNextDeviceClassId() {
    return sequenceMapper.getNextDeviceClassId();
  }

  @Override
  public Long getNextDeviceId() {
    return sequenceMapper.getNextDeviceId();
  }
  ...
  public Long getNextFieldId() {
    return sequenceMapper.getNextFieldId();
  }

  @Override
  public Long getNextCommandId() {
    return sequenceMapper.getNextCommandId();
  }
