...
public class EquipmentCacheObjectFactory extends AbstractEquipmentCacheObjectFactory<EquipmentCacheObject> {

  @Override
  public EquipmentCacheObject sampleBase() {
    EquipmentCacheObject equipmentCacheObject = new EquipmentCacheObject(150L);
