...
public class DeviceCacheConfig {
  ...
  public Cache createCache(AbstractC2monCacheFactory cachingFactory, DeviceDAO deviceDAO) {
    Cache cache = cachingFactory.createCache(C2monCacheName.DEVICE.getLabel(), Long.class, Device.class);
