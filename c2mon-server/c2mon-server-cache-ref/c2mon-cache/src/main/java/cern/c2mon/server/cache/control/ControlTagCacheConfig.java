...
public class ControlTagCacheConfig {
  ...
  public Cache createCache(AbstractC2monCacheFactory cachingFactory, ControlTagLoaderDAO controlTagLoaderDAO) {
    Cache cache = cachingFactory.createCache(C2monCacheName.CONTROLTAG.getLabel(), Long.class, ControlTag.class);
