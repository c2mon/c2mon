...
public interface CacheRegistrationService {
   ...
   */
  Lifecycle registerToAllTags(CacheListener<Tag> tagCacheListener);
   ...
   * and the stop() at the beginning of its own stop method
   */
  Lifecycle registerToAllTags(CacheListener<Tag> tagCacheListener, int nbThreads);
   ...
   * and the stop() at the beginning of its own stop method
   */
  Lifecycle registerToDataTags(CacheListener<DataTag> dataTagCacheListener);
   ...
   * and the stop() at the beginning of its own stop method
   */
  Lifecycle registerToRuleTags(CacheListener<RuleTag> ruleTagCacheListener);
   ...
   * and the stop() at the beginning of its own stop method
   */
  Lifecycle registerToRuleTags(CacheListener<RuleTag> ruleTagCacheListener, int nbThreads);
   ...
   * and the stop() at the beginning of its own stop method
   */
  Lifecycle registerToDataTags(CacheListener<DataTag> dataTagCacheListener, int nbThreads);
   ...
   */
  void registerSynchronousToAllTags(CacheListener<Tag> tagCacheListener);
   ...
   * and the stop() at the beginning of its own stop method
   */
  Lifecycle registerBufferedListenerToTags(BufferedCacheListener<Tag> bufferedTimCacheListener);
   ...
   * and the stop() at the beginning of its own stop method
   */
  Lifecycle registerToAlarms(CacheListener<Alarm> timCacheListener);
}
