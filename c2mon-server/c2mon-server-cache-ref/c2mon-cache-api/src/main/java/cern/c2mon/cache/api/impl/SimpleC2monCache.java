 ...
 */
public class SimpleC2monCache<V extends Cacheable> implements C2monCacheBase<Long, V> {
  ...
  @Override
  public CacheLoader<Long, V> getCacheLoader() {
    return null;
  }

  @Override
  public void setCacheLoader(CacheLoader<Long, V> cacheLoader) {
