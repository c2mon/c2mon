...
public class AliveTag extends AbstractCacheableImpl {
  ...
  String PROCESS_MSG = "Process";
     ...
     * @param aliveInterval
     */
    public AliveTag(final Long aliveTagId, final Long relatedId, final String relatedName,
  ...
  @Override
    public AliveTag clone() {
        AliveTag aliveTimer = (AliveTag) super.clone();
    ...
    public synchronized boolean isProcessAliveType() {
        return (getAliveType().equals(ALIVE_TYPE_PROCESS));
    }
    ...
    public synchronized boolean isEquipmentAliveType() {
        return (getAliveType().equals(ALIVE_TYPE_EQUIPMENT));
    }
    ...
    public synchronized boolean isSubEquipmentAliveType() {
        return (getAliveType().equals(ALIVE_TYPE_SUBEQUIPMENT));
    }
    ...
    public void setAliveType(String aliveType) {
        ...
        this.aliveTypeDescription =
          getAliveType().equals(ALIVE_TYPE_PROCESS) ? PROCESS_MSG
            : getAliveType().equals(ALIVE_TYPE_EQUIPMENT) ? EQUIPMENT_MSG
            : SUBEQUIPMENT_MSG;
    }
