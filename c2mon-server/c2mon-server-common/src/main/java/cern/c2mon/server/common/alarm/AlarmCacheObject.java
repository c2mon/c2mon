...
public class AlarmCacheObject implements Cloneable, Cacheable, Alarm {
	...
	/**
	 * Unique identifier of the DataTagCacheObject to which the alarm is
	 * attached. The Alarm is activated or terminated depending on the current
	 * value of this data tag.
	 */
	 ...
	 * "" and not null - be careful when sending to LASER as this may be the
	 * reason
	 **/
	private String info;
	 ...
	 * Getter method.
	 *
	 * @return the unique identifier of the DataTag to which the alarm is
	 *         attached
	 */
	@Override
