package cern.c2mon.server.supervision.junit;
 ...
 */
@Service
public class SupervisionCachePopulationRule extends DatabasePopulationRule {
  ...
  @Inject
  public SupervisionCachePopulationRule(C2monCache<Process> processCache,
