...
CREATE TABLE IF NOT EXISTS EXPRESSION (
  ...
  EXPR_TEXT      VARCHAR(4000),
  EXPR_DATATYPE  VARCHAR(200) NOT NULL,
  EXPR_VALUE     VARCHAR(4000),
  EXPR_ALARM     INTEGER NOT NULL,
  EXPR_METADATA  VARCHAR(4000),
  PRIMARY KEY (EXPR_TAGID, EXPR_NAME)
);

CREATE TABLE IF NOT EXISTS DSLEXPRESSION (
  EX_ID          INTEGER      NOT NULL,
  EX_NAME        VARCHAR(255) NOT NULL UNIQUE,
  EX_DESCRIPTION VARCHAR(4000),
  EX_DATATYPE    VARCHAR(200) NOT NULL,
  EX_ALARMIDS    VARCHAR(400),
  EX_LOGGED      INTEGER,
  EX_METADATA    VARCHAR(4000),
  EX_EXPRESSION  VARCHAR(4000),
  EX_RULEIDS     VARCHAR(500),
  EX_VALUE       VARCHAR(4000),
  EX_VERSION     VARCHAR(4000),
  PRIMARY KEY (EX_ID)
);
