CREATE SEQUENCE CONFIG_ID_SEQUENCE AS BIGINT START WITH 1 INCREMENT BY 1
CREATE SEQUENCE PROCESS_ID_SEQUENCE AS BIGINT START WITH 100000 INCREMENT BY 1
CREATE SEQUENCE EQUIPMENT_ID_SEQUENCE AS BIGINT START WITH 500000 INCREMENT BY 1
CREATE SEQUENCE TAG_ID_SEQUENCE START AS BIGINT WITH 1000000 INCREMENT BY 1
CREATE SEQUENCE ALARM_ID_SEQUENCE START AS BIGINT WITH 1000000 INCREMENT BY 1
