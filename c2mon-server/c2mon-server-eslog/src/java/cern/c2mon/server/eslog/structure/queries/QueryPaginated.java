...
//    public QueryPaginated(Client client) {
//        super(client);
//    }
//
//    public QueryPaginated(Client client, List<String> indices, boolean isTypeDefined, List<String> types, List<Long> tagIds, int from, int size, int min, int max) {
