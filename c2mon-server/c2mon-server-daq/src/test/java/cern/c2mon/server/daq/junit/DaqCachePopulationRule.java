package cern.c2mon.server.daq.junit;
 ...
 */
@Service
public class DaqCachePopulationRule extends DatabasePopulationRule {
  ...
  @Inject
  public DaqCachePopulationRule(C2monCache<Process> processCache,
