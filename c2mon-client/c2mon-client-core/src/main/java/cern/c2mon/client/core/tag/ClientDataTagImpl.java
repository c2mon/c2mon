...
=======
  ...
  public Collection<Long> getEquipmentIds() {
    return new ArrayList<>(equipmentSupervisionStatus.keySet());
  }

  @Override
  public Collection<Long> getSubEquipmentIds() {
    return new ArrayList<>(subEquipmentSupervisionStatus.keySet());
  }

  @Override
  public Collection<Long> getProcessIds() {
    return new ArrayList<>(processSupervisionStatus.keySet());
  }
