...
/**
 * The SubEquipmentConfiguration allows to apply create, update and delete configurations for SubEquipment.
 *
 * @author Franz Ritter
 */
public interface SubEquipmentConfigurationManager {
   ...
   * <p/>
   * Note: If you create a SubEquipment you have to specify an AliveTag with a {@link cern.c2mon.shared.common.datatag.DataTagAddress}.
   *
   ...
   * @see SubEquipmentConfigurationManager#createSubEquipment(String, SubEquipment)
   */
   ...
   * <p/>
   * Note: You have to use {@link SubEquipment#create(String)} to instantiate the 'equipment' parameter of this method.
   * <br/>
   * Note: If you create a SubEquipment you have to specify an AliveTag with a {@link cern.c2mon.shared.common.datatag.DataTagAddress}.
   *
   ...
   * @return A {@link ConfigurationReport} containing all details of the Process configuration,
   * including if it was successful or not.
   * @see SubEquipmentConfigurationManager#createSubEquipment(String, String, String)
   */
   ...
   * <p/>
   * Note: You have to use {@link SubEquipment#create(String)} to instantiate the 'subEquipment' parameter of this method.
   * <br/>
   * Note: If you create a SubEquipment you have to specify an AliveTag with a {@link cern.c2mon.shared.common.datatag.DataTagAddress}.
   *
   * @param equipmentName The name of the overlying Process.
