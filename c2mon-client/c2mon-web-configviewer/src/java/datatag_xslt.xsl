...
<xsl:stylesheet version="2.0"
  ...
  <!-- process the XML element TagConfig - take missing information from 
  ...
  <xsl:template match="TagConfig">
    ...
    <table class="inline">
      ...
      <xsl:for-each
        select="*[not(local-name() = 'alarmIds' or local-name() = 'hardwareAddress')]">
        ...
        <xsl:if test="position() mod 2 = 0">
          ...
          <xsl:choose>
            ...
            <xsl:when test="local-name() = 'ruleIds'">
              <TD width="25%">
                <a href="{$base_url}{$datatag_url}{long}">
                  <xsl:value-of select="." />
                </a>
              </TD>
            </xsl:when>
      ...
      <tr>
        <td class="highlight bold align_center" colspan="4">Hardware
          Address</td>
      </tr>
      <tr>
        <td colspan="4">
      ...
      <!-- <tr> <td class="highlight bold" style="background:red;"> Publications 
  ...
  <xsl:template match="AlarmValue | alarmValue">
    ...
    <p class="tagName">
      ...
      <A href="{$base_url}{$alarm_xml_url}{@id}/" class="large blue awesome xml_button"
        target="_blank">View Alarm XML >>
      </A>

      <A href="{$help_alarm_url}{@id}" class="large red awesome xml_button"
        target="_blank">View Help Alarm >>
      </A>
    </p>
    <table class="inline">
      ...
      <tr>
        ...
        <td>
          <a href="{$base_url}{$datatag_url}{tagId}">
      ...
      <xsl:for-each
        select="*[not((local-name() = 'tagId') or local-name() = 'active')]">
    ...
    <html>
      ...
      <body>
        ...
        <p class="tagName">
          ...
          <p>
            Process:
            <xsl:value-of select="jms-user" />
            <A href="{$base_url}{$process_xml_url}{jms-user}/" class="large blue awesome xml_button"
              target="_blank">View as XML >>
            </A>
          </p>
        </p>
        <div class="column">
