...
public class C2monTestClientTest {
  ...
  public void testSubscription() {
    System.setProperty("c2mon.test.client.tagids.location", "classpath:resources/c2mon-test-client-tagids.txt");
    System.setProperty("c2mon.client.test.subscription.number", "5");
    System.setProperty("c2mon.client.test.log.name", "test-client-tags");
