...
public class RestConfigStrategy extends TagConfigStrategy implements ITagConfigStrategy {
     // These  Query Keys must be handled specifically as they must be set in the HardwareAddress Constructor.
    ...
    RestConfigStrategy(URI uri) throws DynConfigException {
