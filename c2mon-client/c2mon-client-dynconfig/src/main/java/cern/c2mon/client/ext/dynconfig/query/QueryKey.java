...
public class QueryKey<R> {
    ...
    /**
     * some queries may match both protocol-specific and tag-related builder classes. This function verifies that a
     * key is in fact intended for a certain class.
