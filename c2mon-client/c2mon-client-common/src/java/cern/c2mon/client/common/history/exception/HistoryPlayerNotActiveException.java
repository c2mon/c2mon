...
public class HistoryPlayerNotActiveException extends Exception {
   ...
   */
  public HistoryPlayerNotActiveException(final String message) {
    super(message);
  }
   ...
   */
  public HistoryPlayerNotActiveException(final Throwable cause) {
    super(cause);
  }
   ...
   *          the original exception
   */
  public HistoryPlayerNotActiveException(final String message, final Throwable cause) {
    super(message, cause);
  }
