 ...
 * point - eventProb : the probability that a tag will be updated at a given
 * update point - inRangeProb : the probability that a given update will lie in
 * the min-max tag value range - outDeadBandProb : the probability that an
 * update in the min-max range will lie outside the value deadband - switchProb
 * : for boolean data tags, the probability that a value will switch (initially
 * set to true) - startIn : the time in minutes before tag updates should start
