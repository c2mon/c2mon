...
# The OPC daq host
DAQ_OPC_HOST=cs-ccr-tim8

# set daqs primary host
DAQ_PRIMARY_HOST=cs-ccr-tim8

# set daqs secondary host
DAQ_SECONDARY_HOST=cs-ccr-tim8
...
really_start() {
  ...
  export ADDITIONAL_PARAMS="${ADDITIONAL_PARAMS} -transition"
