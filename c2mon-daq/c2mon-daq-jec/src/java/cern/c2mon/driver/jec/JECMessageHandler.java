...
import cern.c2mon.driver.jec.config.JECCommandTagChanger;
import cern.c2mon.driver.jec.config.JECDataTagChanger;
import cern.c2mon.driver.jec.config.JECEquipmentConfigurationChanger;
...
public class JECMessageHandler extends EquipmentMessageHandler implements Runnable {
    ...
    public void connectToDataSource() throws EqIOException {
        ...
        try {
            ...
            getEquipmentLogger().fatal("Class cern.c2mon.jec." + protocol + " could not be found");
            throw new EqIOException("Class cern.c2mon.jec." + protocol + " could not be found");
        }
        catch (java.lang.IllegalAccessException ex) {
            getEquipmentLogger().fatal("Could not access to class cern.c2mon.jec." + protocol);
            throw new EqIOException("Could not access to class cern.c2mon.jec." + protocol);
        }
