 ...
 *
 */
public class OPCUAMessageHandler extends EquipmentMessageHandler
     ...
     * from the core.
     */
    private final OPCAUAddressParser opcAddressParser = new OPCAUAddressParser();
    ...
    public synchronized void connectToDataSource() throws EqIOException {
        ...
        try {
            List<OPCUAAddress> opcAddresses = 
