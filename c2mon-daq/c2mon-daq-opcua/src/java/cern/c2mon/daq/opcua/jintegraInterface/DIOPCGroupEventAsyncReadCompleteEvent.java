...
/**
 * Event Class 'DIOPCGroupEventAsyncReadCompleteEvent'. Generated 10/5/2006 11:24:10 AM
 ...
 *   DontOverwrite = False
 */
public class DIOPCGroupEventAsyncReadCompleteEvent extends java.util.EventObject {
  public DIOPCGroupEventAsyncReadCompleteEvent(Object source) { super(source); }
  public void init(int transactionID, int numItems, int[] clientHandles, Object[] itemValues, int[] qualities, java.util.Date[] timeStamps, int[] errors) {
