 ...
 *   DontOverwrite = False
 */
public class OPCActivator implements com.linar.jintegra.RemoteObjRef, cern.c2mon.daq.opcua.jintegraInterface.IOPCActivator {
  ...
  // Interface delegates
  private cern.c2mon.daq.opcua.jintegraInterface.IOPCActivatorProxy d_IOPCActivatorProxy = null;

  /** Access this COM class's cern.c2mon.daq.opcua.jintegraInterface.IOPCActivator interface */
  public cern.c2mon.daq.opcua.jintegraInterface.IOPCActivator getAsIOPCActivator() { return d_IOPCActivatorProxy; }
  ...
  public OPCActivator(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IOPCActivatorProxy = new cern.c2mon.daq.opcua.jintegraInterface.IOPCActivatorProxy(CLSID, host, null);
  }
  ...
  public OPCActivator(Object obj) throws java.io.IOException {
    d_IOPCActivatorProxy = new cern.c2mon.daq.opcua.jintegraInterface.IOPCActivatorProxy(obj);
  }
