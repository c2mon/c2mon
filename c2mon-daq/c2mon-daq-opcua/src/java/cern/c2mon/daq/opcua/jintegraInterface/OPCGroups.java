 ...
 *   DontOverwrite = False
 */
public class OPCGroups implements com.linar.jintegra.RemoteObjRef, cern.c2mon.daq.opcua.jintegraInterface.IOPCGroups {
  ...
  // Interface delegates
  private cern.c2mon.daq.opcua.jintegraInterface.IOPCGroupsProxy d_IOPCGroupsProxy = null;

  /** Access this COM class's cern.c2mon.daq.opcua.jintegraInterface.IOPCGroups interface */
  public cern.c2mon.daq.opcua.jintegraInterface.IOPCGroups getAsIOPCGroups() { return d_IOPCGroupsProxy; }
   ...
   *
   * @param    theListener An object that implements the cern.c2mon.daq.opcua.jintegraInterface.DIOPCGroupsEvent interface.
   * @exception java.io.IOException If there are communications problems.
   */
  public void addDIOPCGroupsEventListener(cern.c2mon.daq.opcua.jintegraInterface.DIOPCGroupsEvent theListener) throws java.io.IOException {
   ...
   * @exception java.io.IOException If there are communications problems.
   */
  public void removeDIOPCGroupsEventListener(cern.c2mon.daq.opcua.jintegraInterface.DIOPCGroupsEvent theListener) throws java.io.IOException {
  ...
  public OPCGroups(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IOPCGroupsProxy = new cern.c2mon.daq.opcua.jintegraInterface.IOPCGroupsProxy(CLSID, host, null);
  }
  ...
  public OPCGroups(Object obj) throws java.io.IOException {
    d_IOPCGroupsProxy = new cern.c2mon.daq.opcua.jintegraInterface.IOPCGroupsProxy(obj);
  }
