 ...
 *   DontOverwrite = False
 */
public class DIOPCGroupsEventProxy extends com.linar.jintegra.Dispatch implements ch.cern.tim.driver.jintegraInterface.DIOPCGroupsEvent, java.io.Serializable {
   ...
   * @exception com.linar.jintegra.AutomationException If the remote server throws an exception.
   */
  public void globalDataChange  (ch.cern.tim.driver.jintegraInterface.DIOPCGroupsEventGlobalDataChangeEvent theEvent) throws java.io.IOException, com.linar.jintegra.AutomationException{
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("28e68f9d-8d75-11d1-8dc3-3c302a000000", ch.cern.tim.driver.jintegraInterface.DIOPCGroupsEventProxy.class, null, 0, null );
  }
}
