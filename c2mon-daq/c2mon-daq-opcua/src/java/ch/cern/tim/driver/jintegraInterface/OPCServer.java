 ...
 *   DontOverwrite = False
 */
public class OPCServer implements com.linar.jintegra.RemoteObjRef, ch.cern.tim.driver.jintegraInterface.IOPCAutoServer {
  ...
  // Interface delegates
  private ch.cern.tim.driver.jintegraInterface.IOPCAutoServerProxy d_IOPCAutoServerProxy = null;

  /** Access this COM class's ch.cern.tim.driver.jintegraInterface.IOPCAutoServer interface */
  public ch.cern.tim.driver.jintegraInterface.IOPCAutoServer getAsIOPCAutoServer() { return d_IOPCAutoServerProxy; }
   ...
   *
   * @param    theListener An object that implements the ch.cern.tim.driver.jintegraInterface.DIOPCServerEvent interface.
   * @exception java.io.IOException If there are communications problems.
   */
  public void addDIOPCServerEventListener(ch.cern.tim.driver.jintegraInterface.DIOPCServerEvent theListener) throws java.io.IOException {
   ...
   * @exception java.io.IOException If there are communications problems.
   */
  public void removeDIOPCServerEventListener(ch.cern.tim.driver.jintegraInterface.DIOPCServerEvent theListener) throws java.io.IOException {
  ...
  public OPCServer(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IOPCAutoServerProxy = new ch.cern.tim.driver.jintegraInterface.IOPCAutoServerProxy(CLSID, host, null);
  }
  ...
  public OPCServer(Object obj) throws java.io.IOException {
    d_IOPCAutoServerProxy = new ch.cern.tim.driver.jintegraInterface.IOPCAutoServerProxy(obj);
  }
