 ...
 *   DontOverwrite = False
 */
public class IOPCAutoServerProxy extends com.linar.jintegra.Dispatch implements ch.cern.tim.driver.jintegraInterface.IOPCAutoServer, java.io.Serializable {
   ...
   *
   * @return    An reference to a ch.cern.tim.driver.jintegraInterface.OPCGroups
   * @exception java.io.IOException If there are communications problems.
   * @exception com.linar.jintegra.AutomationException If the remote server throws an exception.
   */
  public ch.cern.tim.driver.jintegraInterface.OPCGroups getOPCGroups  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ch.cern.tim.driver.jintegraInterface.OPCGroups zz_retVal[] = { null };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getOPCGroups", 22, zz_parameters);
    return (ch.cern.tim.driver.jintegraInterface.OPCGroups)zz_retVal[0];
  }
   ...
   *
   * @return    An reference to a ch.cern.tim.driver.jintegraInterface.OPCBrowser
   * @exception java.io.IOException If there are communications problems.
   * @exception com.linar.jintegra.AutomationException If the remote server throws an exception.
   */
  public ch.cern.tim.driver.jintegraInterface.OPCBrowser createBrowser  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ch.cern.tim.driver.jintegraInterface.OPCBrowser zz_retVal[] = { null };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("createBrowser", 27, zz_parameters);
    return (ch.cern.tim.driver.jintegraInterface.OPCBrowser)zz_retVal[0];
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("28e68f92-8d75-11d1-8dc3-3c302a000000", ch.cern.tim.driver.jintegraInterface.IOPCAutoServerProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        ...
        new com.linar.jintegra.MemberDesc("getOPCGroups",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("ppGroups", 29, 20, 5, ch.cern.tim.driver.jintegraInterface.OPCGroups.IID, ch.cern.tim.driver.jintegraInterface.OPCGroups.class) }),
        ...
        new com.linar.jintegra.MemberDesc("createBrowser",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("ppBrowser", 29, 20, 4, ch.cern.tim.driver.jintegraInterface.OPCBrowser.IID, ch.cern.tim.driver.jintegraInterface.OPCBrowserProxy.class) }),
