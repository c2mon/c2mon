 ...
 *   DontOverwrite = False
 */
public class OPCGroup implements com.linar.jintegra.RemoteObjRef, ch.cern.tim.driver.jintegraInterface.IOPCGroup {
  ...
  // Interface delegates
  private ch.cern.tim.driver.jintegraInterface.IOPCGroupProxy d_IOPCGroupProxy = null;

  /** Access this COM class's ch.cern.tim.driver.jintegraInterface.IOPCGroup interface */
  public ch.cern.tim.driver.jintegraInterface.IOPCGroup getAsIOPCGroup() { return d_IOPCGroupProxy; }
   ...
   *
   * @param    theListener An object that implements the ch.cern.tim.driver.jintegraInterface.DIOPCGroupEvent interface.
   * @exception java.io.IOException If there are communications problems.
   */
  @Override
  public void addDIOPCGroupEventListener(ch.cern.tim.driver.jintegraInterface.DIOPCGroupEvent theListener) throws java.io.IOException {
   ...
   * @exception java.io.IOException If there are communications problems.
   */
  public void removeDIOPCGroupEventListener(ch.cern.tim.driver.jintegraInterface.DIOPCGroupEvent theListener) throws java.io.IOException {
  ...
  public OPCGroup(String host) throws java.io.IOException, java.net.UnknownHostException {
    d_IOPCGroupProxy = new ch.cern.tim.driver.jintegraInterface.IOPCGroupProxy(CLSID, host, null);
  }
  ...
  public OPCGroup(Object obj) throws java.io.IOException {
    d_IOPCGroupProxy = new ch.cern.tim.driver.jintegraInterface.IOPCGroupProxy(obj);
  }
