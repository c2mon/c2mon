 ...
 *   DontOverwrite = False
 */
public class DIOPCServerEventProxy extends com.linar.jintegra.Dispatch implements ch.cern.tim.driver.jintegraInterface.DIOPCServerEvent, java.io.Serializable {
   ...
   * @exception com.linar.jintegra.AutomationException If the remote server throws an exception.
   */
  public void serverShutDown  (ch.cern.tim.driver.jintegraInterface.DIOPCServerEventServerShutDownEvent theEvent) throws java.io.IOException, com.linar.jintegra.AutomationException{
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("28e68f93-8d75-11d1-8dc3-3c302a000000", ch.cern.tim.driver.jintegraInterface.DIOPCServerEventProxy.class, null, 0, null );
  }
}
