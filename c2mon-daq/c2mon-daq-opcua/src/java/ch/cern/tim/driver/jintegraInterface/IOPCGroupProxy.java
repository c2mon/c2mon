 ...
 *   DontOverwrite = False
 */
public class IOPCGroupProxy extends com.linar.jintegra.Dispatch implements ch.cern.tim.driver.jintegraInterface.IOPCGroup, java.io.Serializable {
   ...
   *
   * @return    An reference to a ch.cern.tim.driver.jintegraInterface.OPCItems
   * @exception java.io.IOException If there are communications problems.
   * @exception com.linar.jintegra.AutomationException If the remote server throws an exception.
   */
  public ch.cern.tim.driver.jintegraInterface.OPCItems getOPCItems  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    ch.cern.tim.driver.jintegraInterface.OPCItems zz_retVal[] = { null };
    Object zz_parameters[] = { zz_retVal };
    vtblInvoke("getOPCItems", 26, zz_parameters);
    return (ch.cern.tim.driver.jintegraInterface.OPCItems)zz_retVal[0];
  }
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("28e68f96-8d75-11d1-8dc3-3c302a000000", ch.cern.tim.driver.jintegraInterface.IOPCGroupProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        ...
        new com.linar.jintegra.MemberDesc("getOPCItems",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("ppItems", 29, 20, 4, ch.cern.tim.driver.jintegraInterface.OPCItems.IID, ch.cern.tim.driver.jintegraInterface.OPCItemsProxy.class) }),
